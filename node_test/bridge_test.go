...
func TestBridgedFundWithChallenge(t *testing.T) {
	...
	t.Run("Unilaterally exit to L1 using updated L2 ledger channel state after making payments", func(t *testing.T) {
		l2SignedState, err := nodeAPrime.GetSignedState(l2LedgerChannelId)
		if err != nil {
			t.Fatal(err)
		}
...
func TestBridgedFundWithIntermediary(t *testing.T) {
	...
	t.Run("Create ledger channels on L1 and mirror it on L2", func(t *testing.T) {
		// Alice create ledger channel with bridge
		outcome := ledgerOutcome(*nodeA.Address, bridgeAddress, ledgerChannelDeposit, ledgerChannelDeposit, types.Address{})
		l1LedgerChannelResponse, err := nodeA.CreateLedgerChannel(bridgeAddress, uint32(tcL1.ChallengeDuration), outcome)
		if err != nil {
			t.Fatal(err)
		}
		...
		checkLedgerChannel(t, l1AliceBridgeLedgerChannelId, ledgerOutcome(*nodeA.Address, bridgeAddress, ledgerChannelDeposit, ledgerChannelDeposit, types.Address{}), query.Open, nodeA)
		checkLedgerChannel(t, l2AliceBridgeLedgerChannelId, ledgerOutcome(bridgeAddress, *nodeAPrime.Address, ledgerChannelDeposit, ledgerChannelDeposit, types.Address{}), query.Open, nodeAPrime)

		// Irene create ledger channel with bridge
		outcome = ledgerOutcome(*nodeC.Address, bridgeAddress, ledgerChannelDeposit, ledgerChannelDeposit, types.Address{})
		...
		checkLedgerChannel(t, l1CharlieBridgeLedgerChannelId, ledgerOutcome(*nodeC.Address, bridgeAddress, ledgerChannelDeposit, ledgerChannelDeposit, types.Address{}), query.Open, nodeC)
		checkLedgerChannel(t, l2CharlieBridgeLedgerChannelId, ledgerOutcome(bridgeAddress, *nodeCPrime.Address, ledgerChannelDeposit, ledgerChannelDeposit, types.Address{}), query.Open, nodeCPrime)
	})
	...
	t.Run("Create virtual channel on mirrored ledger channel and make payments via bridge as intermediary", func(t *testing.T) {
		...
		checkLedgerChannel(t, l2AliceBridgeLedgerChannelId, ledgerOutcome(*nodeAPrime.Address, bridgeAddress, ledgerChannelDeposit-payAmount, ledgerChannelDeposit+payAmount, types.Address{}), query.Open, nodeAPrime)
		checkLedgerChannel(t, l2CharlieBridgeLedgerChannelId, ledgerOutcome(bridgeAddress, *nodeCPrime.Address, ledgerChannelDeposit-payAmount, ledgerChannelDeposit+payAmount, types.Address{}), query.Open, nodeCPrime)
	})
	...
	t.Run("Exit to L1 using updated L2 ledger channel states after making payments", func(t *testing.T) {
		...
		checkLedgerChannel(t, l1AliceBridgeLedgerChannelId, ledgerOutcome(*nodeA.Address, bridgeAddress, ledgerChannelDeposit-payAmount, ledgerChannelDeposit+payAmount, types.Address{}), query.Complete, nodeA)
		...
		checkLedgerChannel(t, l1CharlieBridgeLedgerChannelId, ledgerOutcome(*nodeC.Address, bridgeAddress, ledgerChannelDeposit+payAmount, ledgerChannelDeposit-payAmount, types.Address{}), query.Complete, nodeC)
