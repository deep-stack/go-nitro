...
// jsonObjective replaces the swapfund Objective's channel pointers
...
// MarshalJSON returns a JSON representation of the SwapFundObjective
// NOTE: Marshal -> Unmarshal is a lossy process. All channel data from
// the swap and ledger channels (other than Ids) is discarded
...
// UnmarshalJSON populates the calling SwapFundObjective with the
// json-encoded data
//
// NOTE: Marshal -> Unmarshal is a lossy process. All channel data from
//
//	the  and ledger channels (other than Ids) is discarded
func (o *Objective) UnmarshalJSON(data []byte) error {
	...
	if err := json.Unmarshal(data, &jsonVFO); err != nil {
		return fmt.Errorf("failed to unmarshal the SwapFundObjective: %w", err)
	}
	...
	// a non-connection to a channel with the zero-Id. swapfund.objective expects
